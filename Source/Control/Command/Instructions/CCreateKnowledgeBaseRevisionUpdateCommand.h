...
#ifndef KONCLUDE_Control_COMMAND_CCREATEKNOWLEDGEBASEREVISIONUPDATECOMMAND_H
#define KONCLUDE_Control_COMMAND_CCREATEKNOWLEDGEBASEREVISIONUPDATECOMMAND_H
	...
	namespace Control {
		...
		namespace Command {
			...
			namespace Instructions {
				...
				/*! 
				 *
				 *		\class		CCreateKnowledgeBaseRevisionUpdateCommand
				 *		\author		Andreas Steigmiller
				 *		\version	0.1
				 *		\brief		TODO
				 *
				 */
				class CCreateKnowledgeBaseRevisionUpdateCommand : public CKnowledgeBaseCommand, public CKnowledgeBaseRevisionCommandProvider {
					// public methods
					public:
						//! Constructor
...
#endif // KONCLUDE_Control_COMMAND_CCREATEKNOWLEDGEBASEREVISIONUPDATECOMMAND_H
